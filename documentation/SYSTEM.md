...
**meal_recommendation_records** *(Module 11 — the KNN candidate pool, 2,000 rows loaded from `datasets/recommendations/Sri_Lankan_Meal_Dataset_NEW.xlsx` via `flask seed-recommendations`)*
